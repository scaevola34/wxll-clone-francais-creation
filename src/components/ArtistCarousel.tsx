    ...
    <div className="relative w-full">
      ...
      >
        <CarouselContent className="-ml-2 md:-ml-4">
          {artists.map((artist) => {
            // Image avec priorité : profile_image_url puis imageUrl puis placeholder
            const displayImage = artist.profile_image_url || artist.imageUrl || '/placeholder.svg';
                    ...
                    <CardContent className="p-6 relative bg-white">
                      ...
                      <div className="absolute -top-8 left-6">
                        <Avatar className="h-16 w-16 border-4 border-white shadow-xl ring-2 ring-wxll-artist/20">
                          <AvatarImage src={displayImage} alt={artist.name} />
