/* ----------------------------------------------------------------
   src/pages/Login.tsx – version complète
   - Connexion Supabase
   - Spinner sur le bouton
   - Toast succès / erreur (hook useToast)
   - Mot de passe visible / caché
   - Mode "mot de passe oublié"
   - Redirection artiste / propriétaire
------------------------------------------------------------------ */
        ...
        <form onSubmit={handleLogin}>
          ...
          <CardFooter className="flex flex-col space-y-6 pt-6">
            ...
            <div className="text-center text-gray-600">
              ...
              <Link
                to="/register"
                className="text-wxll-blue hover:underline font-semibold"
              >
                S’inscrire
              </Link>
            </div>
